...
public class AdminController implements Initializable {
    ...
    public void handleDeleteBook() throws IOException {
        ...
        Stage scene= (Stage) deleteBookButton.getScene().getWindow();
        scene.setTitle("Delete Book");
        scene.setScene(new Scene(root,730,700));
        scene.setFullScreen(false);
        scene.setResizable(false);
        scene.setMinHeight(700);
    ...
    public void handleDownloadBook() throws IOException {
        Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("DownloadBook.fxml"));
        Stage scene= (Stage) downloadBookButton.getScene().getWindow();
        scene.setTitle("Download Book");
        scene.setScene(new Scene(root,730,700));
        scene.setFullScreen(false);
        scene.setResizable(false);
        scene.setMinHeight(700);
    ...
    public void handleTransition2(){
        ...
        KeyValue initKeyValue = new KeyValue(labelMain.translateXProperty(), 1200);
        KeyFrame initFrame = new KeyFrame(Duration.ZERO, initKeyValue);
